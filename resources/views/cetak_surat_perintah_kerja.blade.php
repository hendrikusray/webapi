            ...
            <table class="sparepart-details border_bottom_upper">
                <thead>
                    <tr >
                        ...
                        <th style="text-align:left;" class="col-4">Rak</th>
                        <th></th>
                ...
                <tbody>
                    ...
                    @foreach ($transaksi_penjualan->detail_penjualan_sparepart as $item)
                        <tr>
                            ...
                            <td>{{ $item->sparepart->KODE_PENEMPATAN }}</td>
                            <td></td>
                ...
                <table class="sparepart-details border_bottom_upper">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align:right;">{{$transaksi_penjualan->detail_penjualan_sparepart->sum('JUMLAH_SPAREPART')}}</td>
