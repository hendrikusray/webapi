...
Route::post('inputsupplier','SupplierController@store');
Route::post('inputpegawai','PegawaiController@store');
Route::post('inputsparepart','SparepartController@store');
Route::post('inputpemesanansparepart','PemesananSparepartController@store');
//Route::post('inputjasaservice','JasaServiceController@store');
Route::post('updateGambar/{id}','SparepartController@updateGambar');
Route::post('updateGambar2/{id}','SparepartController@updateGambar2');
Route::get('notalunas/{id}','FilesController@generateNotaPdf');
Route::get('suratperintahkerja/{id}','FilesController@generatePerintahKerjaPdf');
Route::get('suratpemesanan/{id}','FilesController@generatePemesananPdf');
Route::get('PendapatanTahunan','FilesController@PendapatanTahunan');
Route::get('pendapatanBulanan/{tahun}','FilesController@pendapatanBulanan');
///rizka api///
